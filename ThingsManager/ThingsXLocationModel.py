...
class ThingsXLocationModel(ThingsModel):
    def __init__(self, code_things=None, nr_things1=None, nr_things2=None, description=None, situation=None, value=None,
                 ...
                 pblo_id=None, pblo_loca_id=None, pblo_usua_id=None, pblo_dt_first_read=None, pblo_dt_last_read=None):
        super(ThingsXLocationModel, self).__init__(code_things, nr_things1, nr_things2, description, situation, value,
                                                   date_registre, state, location, note, tag_activated,
                                                   location_current)
